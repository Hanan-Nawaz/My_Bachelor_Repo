<%@ Page Title="" Language="C#" MasterPageFile="~/abs.Master" AutoEventWireup="true" CodeBehind="addorganization.aspx.cs" Inherits="ABS_Project.addorganization" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <title>Add Organization &#8211; A Blessed Society</title>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                        <label style="color:blue; font-size: 20px; user-select: none;">Add Organization</label>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="tb_name" runat="server" placeholder="Organization Name" required></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <label>Organization's Cell Number</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="tb_cell" runat="server" placeholder="Organization's Cell Number" required></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="tb_email" runat="server" placeholder="Organization's Email" required></asp:TextBox>
                        </div>
                        </div>
                      <div class="col-md-6">
                        <label>Organization's Address</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="tb_cnic" runat="server" placeholder="Organization's address" required></asp:TextBox>
                        </div>
                     </div>
                    </div>
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList CssClass="form-control" ID="ddl_category" runat="server" AutoPostBack="true" required>
