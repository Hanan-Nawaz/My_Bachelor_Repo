<%@ Page Title="" Language="C#" MasterPageFile="~/abs.Master" AutoEventWireup="true" CodeBehind="registerbenificary.aspx.cs" Inherits="ABS_Project.registerbenificary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
          <title>Add Benificary &#8211; A Blessed Society</title>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                        <label style="color:blue; font-size: 20px; user-select: none;">Add Benificary</label>
                        </center>
                     </div>
                  </div>
                ...
                <div class="row">
                     <div class="col-md-6">
                        <label>Gaurdian Email ID/Contact Number*</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="tb_username" runat="server" placeholder="Email ID"  required></asp:TextBox>
                        </div>
                     </div>
