<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="Exams.aspx.cs" Inherits="MedLearner.Exams" %>
...
<div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px; margin-right: 0px; margin-left:0px;">
        <div class="container text-center">
            <h1 class="text-white display-1">Exams</h1>
            <div class="mx-auto mb-5" style="width: 100%; max-width: 600px;">
                <div class="input-group">
                    <asp:DropDownList runat="server" ID="ddlExamType" OnSelectedIndexChanged="ddlExamType_SelectedIndexChanged" CssClass="btn btn-outline-light bg-white text-body px-4 w-auto" AutoPostBack="true">
                        <asp:ListItem Value="1">Mock Exam</asp:ListItem>
                        <asp:ListItem Value="2">Qusetion Bank</asp:ListItem>
                    </asp:DropDownList>
