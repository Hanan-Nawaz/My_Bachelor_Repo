<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="details.aspx.cs" Inherits="MedLearner.details" %>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom">
        <div class="container text-center py-5">
          ...
          <h6 class="text-white p" runat="server" id="h6Money"></h6>
            <asp:Button ID="btnEnroll" runat="server" Text="Enroll" class="btn btn-primary px-4 px-lg-5 p-3" OnClick="btnEnroll_Click" />
        </div>
    </div>
                ...
                <ItemTemplate>
                            <div class="faq-content ml-2 mr-2 m-1">
                              <div class="faq-question">
                                ...
                                <div class="panel-content"><%#Eval("Instructions") %></div>
                              </div>
                        </div>
