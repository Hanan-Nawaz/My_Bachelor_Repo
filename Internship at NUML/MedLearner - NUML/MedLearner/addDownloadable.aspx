<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="addDownloadable.aspx.cs" Inherits="MedLearner.addDownloadable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Add Downloadable Content</h1>
    ...
    <div class="container-fluid">
         ...
         <div class="col-md-13">
            ...
            <strong>Error!</strong> A problem has been occurred while adding Downloadable Content. 
        </div>  

         <div id="alertSuccess" runat="server" class="alert alert-success">  
            <strong>Congrats!</strong> Downloadable Content Saved Successfully. 
        </div>  

                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-center text-primary">Already Added Downloadable Content</h4>
                    </div>
                </div>
                <div class="row">  
                            <div class="col-lg-12 ">  
                                <div class="table-responsive">  
                                    <asp:GridView ID="grdDownloadable" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="false" DataKeyNames="Id" EmptyDataText="There are no data records to display.">  
                                        <Columns>  
               ...
               <div class="card-body" id="inputForm" runat="server">
                     ...
                     <div class="col">
                        ...
                        <div class="col mx-auto">
                             <center>
                                <label>Videos*</label>
                                <div class="form-group">
                                     <asp:FileUpload ID="img_vid_Upload" CssClass="form-control" AllowMultiple="false" accept=".pdf,.docx" Width="270px" runat="server"  />               
                                </div>
                            </center>
                        </div>                 
                    </div>
                  ...
                  <div class="row mt-5">
                     <div class="col-8 mx-auto">
                        <center>
                           <div class="form-group">
                              <asp:Button class="btn btn-primary btn-block btn-lg" ID="btnAdd" runat="server" Text="Save Downloadable Content" OnClick="btnAdd_Click"/>
                           </div>
                        </center>
                     </div>
                  </div>
