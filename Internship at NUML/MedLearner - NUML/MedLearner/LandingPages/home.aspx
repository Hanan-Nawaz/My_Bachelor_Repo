<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="MedLearner.Home1" %>
            ...
            <div class="courses-item position-relative">
                ...
                <div class="courses-text">
                    ...
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="signin.aspx">Course Detail</a>
                    </div>
                </div>
            </div>
            <div class="courses-item position-relative">
        ...
        <div class="row justify-content-center bg-image mx-0 mb-5">
            <div class="col-lg-6 py-5">
                <div class="bg-white p-5 my-5">
                    <h1 class="text-center mb-4">For New Students</h1>
                    
                                <a class="btn btn-primary btn-block" href="" style="height: 60px; font-size: 30px;">Sign Up Now</a>
                        </div>
                </div>
        </div>
    </div>
