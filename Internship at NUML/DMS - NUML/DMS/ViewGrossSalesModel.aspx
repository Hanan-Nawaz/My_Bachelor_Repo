<%@ Page Title="" Language="C#" MasterPageFile="~/DMS.Master" AutoEventWireup="true" CodeBehind="ViewGrossSalesModel.aspx.cs" Inherits="DMS.ViewGrossSalesModel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>View Gross Sales Model - DMS</title>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <center>
                                <label style="color: blue; font-size: 20px; user-select: none;"><i class="fas fa-list fa-fw "></i>View Gross Sales Model </label>
                            </center>
                        </div>
                    </div>
