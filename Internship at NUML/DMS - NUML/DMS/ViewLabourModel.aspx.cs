...
namespace DMS
{
    public partial class ViewLabourModel : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            string Query = "SELECT * FROM LabourExpenseModel";
        ...
        protected void del_btn_Click(object sender, EventArgs e)
        {
            ...
            string query = "DELETE FROM LabourExpenseModel WHERE Id='" + id + "'";
            SqlCommand cmd = new SqlCommand(query, con);
