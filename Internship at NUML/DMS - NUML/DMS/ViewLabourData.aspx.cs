...
namespace DMS
{
    public partial class ViewLabourData : System.Web.UI.Page
    {
        string id;
        ...
        private void BindGrid()
        {
            ...
            string Query = "SELECT * FROM labor_data_tb";
        ...
        {
            string ID = Convert.ToString((sender as LinkButton).CommandArgument);
            Response.Redirect("ViewLabourDataReport.aspx?ID=" + ID);
        }
    }
}