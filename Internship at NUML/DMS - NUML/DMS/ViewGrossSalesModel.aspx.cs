...
namespace DMS
{
    public partial class ViewGrossSalesModel : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            string Query = "SELECT * FROM sales_revenue_model";
        ...
        protected void del_btn_Click(object sender, EventArgs e)
        {
            ...
            string query = "DELETE FROM sales_revenue_model WHERE Id='" + id + "'";
            SqlCommand cmd = new SqlCommand(query, con);
