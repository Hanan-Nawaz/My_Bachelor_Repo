<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login_page.aspx.cs" Inherits="ITCON_Paid_Project.login_page" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
 <title>NUML - Minute Sheet Management System Login </title>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="text-center">
                                                        ...
                                                        <br />
                                                        <h5><strong>Minute Sheet Management System Login</strong></h5>
                                                        <br />
                                                    </div>
                                                    ...
                                                    <div class="row m-t-20 text-left mb-4 mr-2">
                                                        <div class="col-12 d-flex flex-row-reverse ">
                                                            <div class="forgot-phone  text-right f-right">
                                                                <a class="forgot" href="ForgotPassword.aspx">Forgot Password</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    <div class="row m-t-10">
                                                        <div class="col-md-10 mx-auto mb-4">
                                                            <asp:LinkButton  runat="server" ID="btn_login" OnClick="btnlogin_Click" CssClass="btn btn-info btn-md btn-block waves-effect waves-light text-center m-b-20" >Login</asp:LinkButton>
                                                        </div>
                                                    </div>
